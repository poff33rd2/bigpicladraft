...
import { getAllVideosWithFilter, getVimeoVideosFromFolder, getVimeoVideosFromShowcase } from "backend/vimeo.web.js";
...
export async function fetchAV() {
    ...
    try {
        ...
        console.error("Videos load error:", e?.message || e);
        $w('#repeaterAV').data = [];
    }
}
